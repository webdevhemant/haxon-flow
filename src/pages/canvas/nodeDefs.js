...
export const NODE_DEFS = {
        ...
        inputParams: [
            {
                ...
                label: 'Model Name',
                type: 'options',
                options: ['claude-opus-4-5', 'claude-sonnet-4-5', 'claude-haiku-4-5', 'claude-3-5-sonnet-20241022'],
        ...
        inputParams: [
            {
                ...
                label: 'Model Name',
                type: 'options',
                options: ['gemini-2.0-flash', 'gemini-1.5-pro', 'gemini-1.5-flash', 'gemini-pro'],
    ...
    LLMChain: {
        ...
        outputAnchors: [
            { id: 'out', label: 'LLM Chain' },
            { id: 'text', label: 'Output Prediction' }
        ],
        inputParams: [
        ...
        inputParams: [
            {
                ...
                type: 'textarea',
                rows: 4,
                default: 'The following is a friendly conversation between a human and an AI.'
            },
            { name: 'verbose', label: 'Verbose', type: 'boolean', default: false }
        ]
    },
    ...
    PDFLoader: {
        ...
        inputParams: [
            { name: 'pdfFile', label: 'PDF File', type: 'file', fileType: '.pdf', placeholder: 'Choose a PDF file' },
            {
                ...
                label: 'Usage',
                type: 'options',
                options: ['One document per page', 'One document per file'],
    ...
    Pinecone: {
        ...
        outputAnchors: [
            { id: 'retriever', label: 'Pinecone Retriever' },
            { id: 'vectorStore', label: 'Pinecone Vector Store' }
        ],
        inputParams: [
    ...
    ChromaDB: {
        ...
        outputAnchors: [
            { id: 'retriever', label: 'Chroma Retriever' },
            { id: 'vectorStore', label: 'Chroma Vector Store' }
        ],
        inputParams: [
    ...
    Qdrant: {
        ...
        outputAnchors: [
            { id: 'retriever', label: 'Qdrant Retriever' },
            { id: 'vectorStore', label: 'Qdrant Vector Store' }
        ],
        inputParams: [
    ...
    HuggingFaceEmbeddings: {
        ...
        inputAnchors: [],
        outputAnchors: [{ id: 'out', label: 'Embeddings' }],
        inputParams: [{ name: 'modelName', label: 'Model Name', type: 'string', default: 'sentence-transformers/all-MiniLM-L6-v2' }]
    },
    ...
    SerpAPI: {
        ...
        inputParams: [{ name: 'apiKey', label: 'SerpAPI API Key', type: 'password' }]
    },
    WebBrowser: {
        category: 'Tools',
        label: 'Web Browser',
    ...
    BraveSearch: {
        ...
        inputParams: [{ name: 'apiKey', label: 'Brave API Key', type: 'password' }]
    },
    CustomTool: {
        category: 'Tools',
        label: 'Custom Tool',
    ...
    StructuredOutputParser: {
        ...
        inputParams: [{ name: 'autoFix', label: 'Auto Fix', type: 'boolean', default: false }]
    },
    ...
    IfElseFunction: {
        ...
        outputAnchors: [
            { id: 'true', label: 'If True' },
            { id: 'false', label: 'If False' }
        ],
        inputParams: [
    ...
    SetVariable: {
        ...
        inputParams: [{ name: 'variableName', label: 'Variable Name', type: 'string', default: 'myVar' }]
    },
    GetVariable: {
        category: 'Utilities',
        label: 'Get Variable',
    ...
    StickyNote: {
        ...
        inputAnchors: [],
        outputAnchors: [],
        inputParams: [{ name: 'note', label: 'Note Content', type: 'textarea', rows: 4, default: 'Add your notes here...' }]
    }
}
