...
function StoreDialog({ open, onClose, onSave, initial }) {
    ...
    const handleSave = () => {
        ...
        onSave({
            ...
            embeddingModel,
            color,
            docCount: initial?.docCount || 0,
            chunkCount: initial?.chunkCount || 0,
            status: initial?.status || 'draft'
        })
        setName('')
        setDesc('')
        setVectorStore('Pinecone')
                ...
                <div className='space-y-4 py-2'>
                    ...
                    <div className='space-y-1.5'>
                        ...
                        <Input
                            ...
                            placeholder='What documents does this store contain?'
                        />
                    </div>
