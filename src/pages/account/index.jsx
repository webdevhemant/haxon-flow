            ...
            <Tabs defaultValue='profile'>
                <TabsList className='mb-6'>
                    <TabsTrigger value='profile'>
                        <IconUser size={13} /> Profile
                    </TabsTrigger>
                    <TabsTrigger value='billing'>
                        <IconCreditCard size={13} /> Billing
                    </TabsTrigger>
                    <TabsTrigger value='notifications'>
                        <IconBell size={13} /> Notifications
                    </TabsTrigger>
                    <TabsTrigger value='security'>
                        <IconShield size={13} /> Security
                    </TabsTrigger>
                </TabsList>
                        ...
                        <CardContent>
                            ...
                            <div className='flex gap-2 pt-4 border-t border-border'>
                                ...
                                <Button
                                    ...
                                    onClick={() => toast.info('Please contact support')}
                                >
                                    Cancel Plan
                                </Button>
                            </div>
                                ...
                                <div key={u.label}>
                                    <div className='flex items-center justify-between text-xs mb-1.5'>
                                        ...
                                        <span className='font-mono text-foreground'>
                                            {typeof u.value === 'number' && u.value > 1000 ? (u.value / 1000000).toFixed(1) + 'M' : u.value}{' '}
                                            / {typeof u.max === 'number' && u.max > 1000 ? (u.max / 1000000).toFixed(0) + 'M' : u.max}{' '}
                                            {u.unit}
                                        </span>
                                    </div>
                                ...
                                <div key={n.label} className='flex items-center justify-between py-2'>
                                    ...
                                    <button
                                        ...
                                        className={cn(
                                            ...
                                            n.enabled ? 'bg-primary' : 'bg-secondary border border-border'
                                        )}
                                    >
                                        <div
                                            className={cn(
