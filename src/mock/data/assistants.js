export const assistants = [
    {
        id: 'asst-001',
        name: 'Aria — Support',
        description: 'Empathetic customer support assistant with escalation and ticket management capabilities',
        model: 'gpt-4o',
        type: 'custom',
        conversations: 2341,
    ...
    },
    {
        id: 'asst-002',
        name: 'Dev Buddy',
        description: 'Code-focused assistant with access to documentation, code execution, and Git tools',
    ...
    },
    {
        id: 'asst-003',
        name: 'Research Pro',
        description: 'In-depth research assistant with web search, paper retrieval, and citation management',
        model: 'gemini-1.5-pro',
        type: 'custom',
        conversations: 934,
        createdDate: '2026-04-20T08:00:00Z',
        systemPrompt: 'You are Research Pro, a meticulous academic research assistant...',
        tools: ['web_search', 'arxiv_search', 'pdf_reader']
    },
    {
        id: 'asst-004',
        name: 'OpenAI Assistant (GPT-4o)',
        description: 'Managed OpenAI assistant with file handling and code interpreter',
        model: 'gpt-4o',
        type: 'openai',
        conversations: 456,
