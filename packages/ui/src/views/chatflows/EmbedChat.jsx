...
const embedPopupHtmlCode = (chatflowid) => {
    ...
    import Chatbot from "https://cdn.jsdelivr.net/npm/haxon-embed/dist/web.js"
    Chatbot.init({
...
const embedPopupReactCode = (chatflowid) => {
    return `import { BubbleChat } from 'haxon-embed-react'
...
const embedFullpageHtmlCode = (chatflowid) => {
    return `<haxon-flow-fullchatbot></haxon-flow-fullchatbot>
<script type="module">
    import Chatbot from "https://cdn.jsdelivr.net/npm/haxon-embed/dist/web.js"
    Chatbot.initFull({
        chatflowid: "${chatflowid}",
...
const embedFullpageReactCode = (chatflowid) => {
    return `import { FullPageChat } from "haxon-embed-react"
...
export const defaultThemeConfig = {
    ...
    disclaimer: {
        title: 'Disclaimer',
        message: 'By using this chatbot, you agree to the <a target="_blank" href="https://haxon.ai/terms">Terms & Condition</a>',
        textColor: 'black',
        buttonColor: '#3b82f6',
                            ...
                            <span>
                                ...
                                <p>
                                    ...
                                    <a
                                        rel='noreferrer'
                                        target='_blank'
                                        href='https://www.npmjs.com/package/haxon-embed?activeTab=versions'
                                    >
                                        version
                                    </a>
                                    :&nbsp;<code>{`https://cdn.jsdelivr.net/npm/haxon-embed@<version>/dist/web.js`}</code>
                                </p>
                            </span>
